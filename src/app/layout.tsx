...
export const metadata: Metadata = {
  ...
  description: "Professional printing services including roll-ups, stickers, t-shirts, and more. Quality on-demand printing for all your needs in Algeria.",
  keywords: ["printing", "roll-ups", "stickers", "t-shirts", "banners", "Algeria", "custom printing"],
  ...
  openGraph: {
    ...
    description: 'Quality printing solutions for all your needs. From roll-ups to custom t-shirts, we bring your ideas to life.',
    images: [
      {
